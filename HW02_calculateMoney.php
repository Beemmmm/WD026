...
<body>
    ...
    <div class="card mt-5 mb-3 w-50 mx-auto" id="Result" >
            ...
            if(isset($_POST['price'])&&isset($_POST['amount'])){
                ...
                if(is_numeric($price) && is_numeric($amount)){
                    ...
                    echo "<div class='alert alert-danger text-center'>Please input valid numerric value fo Price and Amount.</div>";
                    }
